...
const AUTHORS_BY_LANGUAGE = {
  ...
  'Французский': [
    ...
    ['Antoine de Saint-Exupéry', 'FR', '«Маленький принц» — самая переводимая книга французской литературы.'],
    ...
    ['Albert Camus', 'FR', '«Посторонний» — лауреат Нобелевской премии, ключевой текст экзистенциализма.'],
