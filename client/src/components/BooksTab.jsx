...
const AUTHORS_BY_LANGUAGE = {
  'Английский': [
    ['Agatha Christie', 'GB', 'самый издаваемый автор детективов в истории — 38 книг в этой полке.'],
    ['Roald Dahl', 'GB', '15 книг здесь в оригинале — «Матильда», «БДВ», «Чарли и шоколадная фабрика».'],
    ['Jane Austen', 'GB', 'родоначальница романа нравов — «Гордость и предубеждение», ирония и точность наблюдений.'],
    ['William Shakespeare', 'GB', '8 пьес здесь — вершина английского языка, но и самый тяжёлый: архаичный синтаксис и лексика.'],
    ['Arthur Conan Doyle', 'GB', 'создал Шерлока Холмса и жанр дедуктивного детектива.'],
    ['Ben Aaronovitch', 'GB', 'urban fantasy про магию в современном Лондоне — 9 книг серии «Реки Лондона».'],
    ['James Dashner', 'US', '«Бегущий в лабиринте» — одна из главных дистопических YA-серий 2010-х.'],
    ['Terry Pratchett', 'GB', 'один из лучших англоязычных стилистов, мастер иронии.'],
    ['Martha Wells', 'US', '«Дневники Киллербота» — обладатель Hugo и Nebula, любимец критиков за иронию.'],
    ['Jasper Fforde', 'GB', 'литературная фантастика про мир, где можно буквально войти в книгу.'],
    ['Pierce Brown', 'US', '«Красный восход» — одна из самых успешных современных space opera серий.'],
    ['Suzanne Collins', 'US', 'автор «Голодных игр», одной из самых успешных YA-серий XXI века.'],
    ['Rick Riordan', 'US', '«Перси Джексон» — миллионы читателей открыли через него греческую мифологию.'],
    ['Sarah J. Maas', 'US', 'одна из самых читаемых авторов современного romantasy — «Двор шипов и роз».'],
    ['Neil Gaiman', 'GB', 'лауреат Hugo, Nebula, Locus, современный мастер сказки для взрослых.'],
  ],
  'Французский': [
    ['Alexandre Dumas', 'FR', 'мастер приключенческого романа — «Три мушкетёра», «Граф Монте-Кристо» — 11 книг здесь, самый представленный автор полки.'],
    ['René Goscinny', 'FR', 'создал «Маленького Николя» и «Астерикса» — классика французского юмора для детей.'],
    ['Marcel Pagnol', 'FR', 'автор автобиографической тетралогии о детстве в Провансе — эталонный простой и красивый французский.'],
    ['Daniel Pennac', 'FR', 'серия «Камо» — одна из самых любимых подростковых серий французской литературы.'],
    ['Victor Hugo', 'FR', '«Отверженные» и «Собор Парижской Богоматери» — вершина французского романтизма.'],
    ['Jules Verne', 'FR', 'отец жанра приключенческой фантастики — «Вокруг света за 80 дней», «20000 льё под водой».'],
    ['Jean-Claude Mourlevat', 'FR', 'современный мастер подростковой фантастики — «Река, текущая вспять».'],
    ['Anna Gavalda', 'FR', 'одна из самых популярных современных французских писательниц, лёгкий и тёплый стиль.'],
    ['Éric-Emmanuel Schmitt', 'FR', 'философские повести о взрослении и вере — короткие, но глубокие.'],
  ],
  'Арабский': [
    ['نجيب محفوظ — Нагиб Махфуз', 'EG', 'единственный арабский лауреат Нобелевской премии по литературе (1988) — самый представленный автор в этой полке.'],
    ['غسان كنفاني — Гассан Канафани', 'PS', 'ключевой голос палестинской литературы — «Люди на солнце», «Возвращение в Хайфу».'],
    ['عمرو عبد الحميد — Амр Абдульхамид', 'EG', 'один из самых популярных современных египетских young-adult авторов — фэнтези и приключения.'],
    ['كامل كيلاني — Камиль Киляни', 'EG', 'основоположник арабской детской литературы, автор пересказов «Синдбада» и «Али-Бабы».'],
    ['أحلام مستغانمي — Ахлам Мостаганеми', 'DZ', 'самая продаваемая арабоязычная писательница — трилогия о любви и памяти, начиная с «Памяти тела».'],
    ['رضوى عاشور — Радва Ашур', 'EG', '«Гранадская трилогия» — судьба мусульманской семьи после падения Гранады.'],
    ['الطيب صالح — Тайиб Салих', 'SD', '«Сезон миграции на Север» считается одним из главных арабских романов XX века.'],
    ['أحمد خالد توفيق — Ахмед Халед Тауфик', 'EG', 'отец арабской хоррор- и научной фантастики, культовый автор для целого поколения читателей.'],
    ['غادة السمان — Гада ас-Самман', 'SY', 'сирийская писательница — любовь, война и Бейрут глазами женщины.'],
    ['أحمد مراد — Ахмед Мурад', 'EG', 'современный мастер психологического триллера — «Синий слон», «1919».'],
    ['علاء الأسواني — Алаа аль-Асвани', 'EG', '«Дом Якобяна» — один из самых известных арабских романов XXI века на Западе.'],
    ['إلياس خوري — Элиас Хури', 'LB', '«Врата солнца» — большой эпос о Палестине и изгнании.'],
    ['جبران خليل جبران — Джебран Халиль Джебран', 'LB', 'автор «Пророка», самый переводимый арабский поэт-философ.'],
    ['توفيق الحكيم — Тауфик аль-Хаким', 'EG', 'один из основателей современной арабской драмы и романа.'],
  ],
  'Шведский': [
    ['Roald Dahl', 'GB', 'его книги здесь читаются в шведском переводе — «Матильда», «Чарли и шоколадная фабрика».'],
    ['Hergé', 'BE', 'бельгийский автор комиксов «Приключения Тинтина», в библиотеке — шведские издания.'],
    ['Astrid Lindgren', 'SE', 'главная шведская детская писательница — «Пеппи Длинныйчулок», «Братья Львиное Сердце».'],
    ['Maria Gripe', 'SE', 'мастер шведской подростковой мистики и психологической прозы — 5 книг здесь.'],
    ['Annika Thor', 'SE', 'трилогия об островной девочке — беженке времён Второй мировой.'],
  ],
  'Хинди': [
    ['प्रेमचंद — Премчанд', 'IN', 'крупнейший прозаик хинди и урду XX века, мастер рассказа и романа о деревне и человеческом достоинстве — 9 книг здесь.'],
    ['कृष्णा सोबती — Кришна Собти', 'IN', 'одна из главных фигур хинди-модернизма, смело писала о женском желании и теле.'],
    ['मन्नू भंडारी — Манну Бхандари', 'IN', 'одна из главных женских голосов хинди-прозы XX века — семья, брак, женская судьба.'],
    ['उषा प्रियंवदा — Уша Приямвада', 'IN', 'тонкий психологический реализм — женская свобода, брак, эмиграция.'],
    ['निर्मल वर्मा — Нирмал Варма', 'IN', 'ключевой модернист хинди-прозы, мастер настроения и одиночества.'],
    ['यशपाल — Яшпал', 'IN', 'трилогия «Ложная правда» — один из главных романов о разделе Индии.'],
    ['जैनेन्द्र कुमार — Джайнендра Кумар', 'IN', 'мастер психологического романа хинди, тонкий анализ внутреннего мира и общественных норм.'],
    ['भीष्म साहनी — Бхишма Сахни', 'IN', '«Тамас» — один из главных романов о разделе Индии 1947 года.'],
  ],
};
...
export default function BooksTab({ ownerId }) {
  ...
  return (
    <div>
      ...
      {AUTHORS_BY_LANGUAGE[selectedLanguage] && (
        <div className="tip-card" style={{ marginTop: 18 }}>
          ...
          <p style={{ margin: '0 0 12px', fontSize: 12.5, color: 'var(--ink-soft)', lineHeight: 1.6 }}>
            Их книги входят в список выше:
          </p>
          <ul style={{ margin: 0, paddingLeft: 18, fontSize: 12.8, lineHeight: 1.85, color: 'var(--ink)' }}>
            {AUTHORS_BY_LANGUAGE[selectedLanguage].map(([name, countryCode, desc]) => (
              <li key={name}>
