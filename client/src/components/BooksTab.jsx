...
const AUTHORS_BY_LANGUAGE = {
  ...
  'Арабский': [
    ['نجيب محفوظ — Нагиб Махфуз', 'EG', 'единственный арабский лауреат Нобелевской премии по литературе (1988), автор Каирской трилогии.'],
    ...
    ['خالد خليفة — Халед Халифа', 'SY', 'один из главных современных сирийских писателей, пишет о войне и семье.'],
    ['رضوى عاشور — Радва Ашур', 'EG', '«Гранадская трилогия» — судьба мусульманской семьи после падения Гранады.'],
    ['طه حسين — Таха Хусейн', 'EG', 'слепой писатель и реформатор, «Дни» — одна из главных арабских автобиографий.'],
